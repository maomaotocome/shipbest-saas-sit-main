  ...
  const parameterConfig: ModelParameterConfig = {
    parameters: [
...

      {
        ...
        max_count: 3,
        label: parameterLabels.imageUrls[locale],
        defaultValue: "",
        required: false,
        description: "Image URLs for image-to-video generation (comma-separated, max 3)",
        is_additional: false,
      } as ParameterConfig,

      {
        ...
        defaultValue: "veo3",
        options: [{ value: "veo3", label: "Standard" }],
        required: false,
        is_additional: true,
        hidden: true,
      } as ParameterConfig,

      {
        key: "watermark",
        type: ParameterType.TEXT,
        label: parameterLabels.watermark[locale],
        defaultValue: "",
        required: false,
        description: "Optional watermark text to add to the video",
        is_additional: true,
      } as ParameterConfig,
    ],
  };
