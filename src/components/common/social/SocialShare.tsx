    ...
    <div className={`flex flex-wrap gap-2 ${className}`}>
      {socialLinks.map((social) => (
        <a
          ...
          className={`inline-flex h-8 w-8 items-center justify-center rounded-full ${social.color} hover:bg-opacity-90 text-white transition-colors`}
      ...
      <Button
        ...
        variant="outline"
        size="sm"
        className="bg-primary/10 text-primary hover:bg-primary/20 inline-flex h-8 w-8 items-center justify-center rounded-full p-0 transition-colors"
