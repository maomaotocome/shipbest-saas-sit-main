...
import { submitFalApiTaskWithConfig } from "./submit";

/**
 * Unified FAL task runner for all task types
 */
export async function runFalTask({
  ...
  return await submitFalApiTaskWithConfig({
    falModel: modelInfo.providerModel,
